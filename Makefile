...
SRC_NAME =	main.cpp mtdf.cpp NegaMax.cpp Game.cpp GameEngine.cpp GraphicalInterface.cpp BitBoard.cpp Chronometer.cpp \
			Button.cpp ButtonSwitch.cpp ButtonSelect.cpp FontHandler.cpp FontText.cpp Analytics.cpp Player.cpp \
			Human.cpp Computer.cpp 
